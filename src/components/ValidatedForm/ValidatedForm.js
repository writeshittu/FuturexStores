      ...
      <form>
        ...
        <div className={styles.fieldGroup}>
          ...
          <input
            type="text"
            className={
              lastName.isTouched && !lastName.isValid ? styles.hasError : null
            }
            name="lastName"
        ...
        <div className={styles.fieldGroup}>
          <label>Phone</label>
          <input
            className={phone.isTouched && !phone.isValid ? styles.hasError : ""}
            name="phone"
        ...
        <div className={styles.fieldGroup}>
          <label>Email</label>
          <input
            className={email.isTouched && !email.isValid ? styles.hasError : ""}
            name="email"
